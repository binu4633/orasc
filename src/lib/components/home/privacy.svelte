<div class="bg-primary pt-10 px-2 py-10 sm:px-10">
      ...
      <h5 class="font-bold mt-5">Personal information we collect:</h5>
       ...
       <h5 class="font-bold mt-5">Links to other websites:</h5>
       ...
       <h5 class="font-bold mt-5">Information security:</h5>
       ...
       <h5 class="font-bold mt-5">Legal disclosure:</h5>
       ...
       <h5 class="font-bold mt-5">Contact information:</h5>
       <p>If you would like to contact us to understand more about this Policy or wish to contact us concerning any matter relating to individual rights and your Personal Information, you may send an email to info@orasc.in.</p>
      </div>
</div>