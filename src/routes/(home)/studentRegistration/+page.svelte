<script lang="ts">
  ...
  <div class="bg-primary text-center">
     <h1 class="text-4xl">student registration</h1>
     <div>
      <p>if you already registered <a href="/studentRegCheckout" class="text-white-400">goto checkout</a></p>
    </div>
  </div>
...
<div class="bg-primary  pt-16 flex justify-center ">
    <form action="" enctype="multipart/form-data" method="post"  class="bg-primary-dark mb-10 w-[90vw]  sm:w-[40vw] md:w-[40vw] lg:w-[40vw]  p-5 rounded-lg">
      ...
      <div class="input-div">
        ...
        <input type="text" id="lastName" name="lastName" class="input-form" value={form?.data?.lastName} />
      ...
      <div class="input-div">
        ...
        <input type="date" id="date-of-birth" name="dateOfBirth" class="input-form" value={form?.data?.dateOfBirth} />
      ...
      <div class="input-div">
        ...
        <select name="gender" id="gender" class="input-form" value={form?.data?.gender} >
      ...
      <div class="input-div">
        ...
        <input type="email" id="email" name="email" class="input-form" value={form?.data?.email} />
      ...
      <div class="input-div">
        ...
        <textarea  id="address" name="address" class="input-form" value={form?.data?.address} ></textarea>
      ...
      <div class="input-div">
        ...
        <input type="text" id="city" name="city" class="input-form" value={form?.data?.city} />
        {#if form?.errors.city}
      ...
      <div class="input-div">
        ...
        <input type="text" id="state" name="state" class="input-form" value={form?.data?.state} />
      ...
      <div class="input-div">
        ...
        <input type="text" id="country" name="country" class="input-form" value={form?.data?.country} />
      ...
      <div class="input-div">
        ...
        <input type="number" id="pincode" name="pincode" class="input-form" value={form?.data?.pincode} />
      ...
      <div class="input-div">
        ...
        <input type="number" id="phone-number" name="number" class="input-form" value={form?.data?.number} />
      ...
      <div class="input-div">
        ...
        <select name="qualification" id="qualification" class="input-form" value={form?.data?.qualification} >
            <option value="">Please choose an option</option>
      ...
      <div class="input-div">
        <label for="preferred courses" class="input-label">Preferred courses:</label><br>
        <textarea  id="preferredCourses" name="preferredCourses" class="input-form" value={form?.data?.preferredCourses} ></textarea>
        {#if form?.errors.preferredCourses}
        <p class="text-red-500">{form.errors.preferredCourses[0]}</p>
      {/if}
      </div>
      <div class="input-div">
        <label for="preferred country" class="input-label">Preferred countries:</label><br>
        <textarea  id="preferredCountry" name="preferredCountries" class="input-form" value={form?.data?.preferredCountries} ></textarea>
