<script lang="ts">
  ...
  <div class="bg-primary text-center">
    ...
    <div>
     <p>if you already registered <a href="/jobCandidateRegistrationCheckout" class="text-white-400">goto checkout</a></p>
   </div>
 </div>
<div class="bg-primary  pt-16 flex justify-center ">
    <form action="" enctype="multipart/form-data" method="post"  class="bg-primary-dark mb-10 w-[90vw]  sm:w-[40vw] md:w-[40vw] lg:w-[40vw]  p-5 rounded-lg">
      ...
      <div class="input-div">
        ...
        <textarea  id="preferredJobs" name="preferredJobs" class="input-form" value={form?.data?.preferredJobs} ></textarea>
